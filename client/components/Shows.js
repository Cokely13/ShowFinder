...
//     }
//     if (sortOrder === "ASC") {
//       filteredShows = filteredShows.sort((a, b) => (a.name > b.name) ? 1 : -1);
//     }
//     if (sortOrder === "DESC") {
//       filteredShows = filteredShows.sort((a, b) => (a.name < b.name) ? 1 : -1);
//     }
...
//             <div className="col">
//               <h1 className="border border-5 rounded border-dark text-white-50 bg-dark text-center" style={{ marginBottom: "10px", marginLeft: "auto", marginRight: "auto", width: "15rem" }}>All Shows</h1>
//             </div>
//           </div>
//         </div>
//         {statusView === "LIST" ? (
//           <div style={{ marginLeft: "35px" }}>
//             <select onChange={handleStatusFilter} name="filterEvents" className='custom-select' value={statusFilter}>
//               <option value="">By Status</option>
//               <option value="All">All</option>
//               <option value="Ended">Ended</option>
//               <option value="Running">Running</option>
//             </select>
//             <select onChange={handleSortOrder} name="sortEvents" className='custom-select' value={sortOrder}>
...
//                 <input style={{ width: "100%", padding: "12px 20px", marginLeft: "10px", border: "4px solid grey", }} placeholder="Search Show Name" onChange={event => setQuery(event.target.value)} />
//               </div>
//             </div>
//             {shows.filter(show => {
//               if (query === '') {
...
//               if (statusFilter === 'All') {
//                 return show;
//               } else if (show.status === statusFilter) {
//                 return show;
//               }
//             }).sort((a, b) => {
//               if (sortOrder === 'ASC') {
...
//             }).map((show) => {
//               return (
//                 <h3 key={show.id} style={{ marginTop: "10px", marginBottom: '10px', marginLeft: "25%", }}>
//   <Link to={`/shows/${show.id}`}>{show.name}</Link>
//   <div>{show.status}</div>
//   {(show.ratings.length) ? (
//     <div className="mt-1">Average Rating: {Math.floor((show.ratings.map(item => item.rating).reduce((prev, next) => prev + next))/(show.ratings.length))}</div>
//   ) : (
//     <div>No Ratings Yet</div>
//   )}
//   {show.ratings.length ? (
//     <div className="mt-1">Number of Ratings: {(show.ratings.length)}</div>
//   ) : (
//     <div></div>
//   )}
//   {(show.ratings.length) ? (
