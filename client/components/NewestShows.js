...
export default function NewestShows() {
  ...
  return (
    <div>
    <h1 className="border border-5 rounded  border-dark text-white-50 bg-dark text-center" style={{marginBottom: "10px", marginLeft: "auto", marginRight: "auto", width: "20rem"}}>Newest Shows</h1>
...
<div className="carousel-inner">
    <div className="carousel-item active">
      <img className="d-block w-100 border border-5 rounded  border-dark" style={{height: "50rem",}} src={newestimages[0]} alt="First slide"/>
    </div>

    <div className="carousel-item border border-5 rounded  border-dark">
    <img className="d-block w-100" style={{height: "50rem",}} src={newestimages[1]} alt="Second slide"/>
    </div>
    <div className="carousel-item border border-5 rounded  border-dark">
    <img className="d-block w-100" style={{height: "50rem",}} src={newestimages[2]}alt="Third slide"/>
    </div>
    </div>
