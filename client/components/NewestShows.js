...
export default function NewestShows() {
  ...
  return (
    <div>
    <h1 className="border border-5 rounded  border-dark text-white-50 bg-dark text-center" style={{marginBottom: "10px", marginLeft: "auto", marginRight: "auto", width: "30rem"}}>Newest Shows</h1>
...
<div className="carousel-inner">
    <div className="carousel-item active">
      <img className="d-block w-100 border border-5 rounded  border-dark" src={newestimages[0]} alt="First slide"/>
    </div>
